        ...
        <Box data-aos="fade-up"
            ...
            <Box sx={{ backgroundColor: '#282828', mt: { xs: -8, sm: -12, md: -12 }, pb: 2 }}>
                <Box sx={{ pt: 8, mx: [2.5, 4] }}>
                    <Typography sx={{ fontSize: '18px', fontFamily: 'sans-serif', fontWeight: '500', color: 'white', letterSpacing: 1, textTransform: 'uppercase', mx: 2, my: 0.5 }}>Maha's</Typography>
                    <Typography sx={{ fontSize: '15px', fontFamily: 'sans-serif', fontWeight: '500', color: 'white', letterSpacing: 5, textTransform: 'uppercase' }}>Lettering</Typography>
                </Box>
