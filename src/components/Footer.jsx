        ...
        <Box data-aos="fade-up"
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', my: ['0rem', '1.5rem'], }}>
                <Box sx={{ bgcolor: '#282828', width: ['7rem', '7rem', '9rem'], height: ['7rem', '7rem', '9rem'], display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '100%' }}>
                    <Box component='img' src='/logoh.png' alt="customer" sx={{ width: ['8rem', '8rem', '10.5rem'], height: ['8rem', '8rem', '10.5rem'], borderRadius: '100%' }} />
                </Box>
            </Box>
                    ...
                    <Grid container spacing={6} justifyContent={{ xs: 'flex-start', md: 'center' }}>
                        ...
                        <Grid item xs={12} sm={6} lg={3}>
                            <Box>
                                ...
                                <Box sx={{ mt: 2 }}>
                                    <Fab component='a'
                                        href='https://wa.me/916369842254' sx={{ backgroundColor: 'white', mx: 0.5, color: '#282828' }}>
                                        <WhatsAppIcon />
                                    </Fab>
                                    <Fab component='a'
                                        href='https://www.instagram.com/chan_dru472?igsh=Z2UxMmR2M3Bib3U=' sx={{ backgroundColor: 'white', mx: 0.5, color: '#282828' }}>
                                        <InstagramIcon />
                                    </Fab>
                                    <Fab sx={{ backgroundColor: 'white', mx: 0.5, color: '#282828' }}>
                                        <FacebookIcon />
                                    </Fab>
                                </Box>
                            </Box>
